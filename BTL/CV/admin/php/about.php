...
?> 
    ...
    <input type="text" name="dob" value="<?=$data['dob']?>" class="form-control" id="dob" placeholder="...">
  </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="modal-dialog">
    ...
    <input type="text" name="score" value="<?=$data2['score']?>" class="form-control" id="website" placeholder="...">
  </div>
        </div>
      </div>
